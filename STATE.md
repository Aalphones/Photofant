...
**Phase:** 3/5 — API-Kontrakt (DTOs), Tier: standard (pending)
**Nächster Schritt:** Commit für Phase 2, dann `/clear` + `phase-3-api-dtos.md` lesen (Kontext-Diät).
...
|---|---|---|---|
| [P11](docs/planning/2026-06-22_p11-duale-duplikaterkennung/README.md) | Duale Duplikaterkennung (DHash + CLIP) | 5 (P1 done, P2 heikel next) | in-progress |
