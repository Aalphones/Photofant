...
| # | Phase | Rating | Status |
|---|---|---|---|
| 1 | [Domänen: Feld-Fragen und bevorzugte Quellen](phase-1-domaenen-schema.md) | standard | pending |
| 2 | [Interview: Fragen aus der Domäne, Antworten feldgenau](phase-2-interview-fragen-merkmale.md) | heikel | pending |
