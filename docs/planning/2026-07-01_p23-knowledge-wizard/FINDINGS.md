...
- [ ] → Phase 3: `EntityWizardDialog` (`features/wissen/entity-wizard-dialog/`) hat bereits einen
...
- [ ] → Phase 3: `store/knowledge/` ist als EntityAdapter für **Domänen** aufgebaut (`selectId =
