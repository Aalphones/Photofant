...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideEffects([JobsEffects, GalleryEffects, TrashEffects, MaintenanceEffects, ModelsEffects, PresetsEffects, TagsEffects, CollectionsEffects, ReviewEffects]),
  ],
};
